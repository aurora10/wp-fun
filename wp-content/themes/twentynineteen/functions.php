...
function nr_login_logo() { $nr_login_logo = '<style type="text/css">h1 a { width: auto !important; background-image:url('.get_template_directory_uri().'/images/admin/gallardo.svg) !important; background-repeat: no-repeat; background-position: center center !important; background-size: 200px 100px !important; height: 100px !important; } .login #backtoblog a:focus, .login nav a:focus, .login h1 a:focus { -webkit-box-shadow: none; box-shadow: none; }</style>'; echo $nr_login_logo; }
add_action('login_head', 'nr_login_logo');

function nr_login_headerurl() { return home_url(); }
add_filter('login_headerurl', 'nr_login_headerurl');

function nr_login_headertext() { }
add_filter('login_headertext', 'nr_login_headertext');
...
function nr_footer_version() { return '<a target="_blank" href="https://example.com" id="agency-copyright"><img alt="" src="'.get_template_directory_uri().'/images/admin/logo.svg" width="112" height="28"></a>'; }
